...
from ..models import GOOSEPublisherState, RTUDevice, VulnerabilityFinding
...
def _check_goose_no_tls(
    device: RTUDevice, pubs: List[GOOSEPublisherState]
) -> List[VulnerabilityFinding]:
    """
...
def _check_mms_no_tls(device: RTUDevice) -> List[VulnerabilityFinding]:
    """
